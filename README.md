...
Wubba Lubba Dub Dub! Este é um bot interdimensional desenvolvido com **Python** e **LangGraph** para explorar o universo de Rick and Morty através da API oficial.
...
Siga estes comandos sequencialmente para preparar o ambiente e instalar o que é necessário:
```bash
